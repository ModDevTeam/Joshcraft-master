...
public class BrightRoseOre extends Block {
	
	public BrightRoseOre(int id) {
	...
	public int idDropped(int par1, Random random, int par3) {
		...
		return Items.BrightRoseGem.itemID;
	...
	public void registerIcons(IconRegister icon) {
		...
		blockIcon = icon.registerIcon(Info.MODID + ":BrightRoseOre");
